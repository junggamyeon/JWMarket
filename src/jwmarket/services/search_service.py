...
class SearchService:
    ...
    def find_category_for_item(self, item_type: str) -> str | None:
        ...
        if "sword" in item_lower or "pickaxe" in item_lower or "axe" in item_lower or "shovel" in item_lower or "hoe" in item_lower or "mace" in item_lower or "bow" in item_lower or "trident" in item_lower or "shield" in item_lower or "helmet" in item_lower or "chestplate" in item_lower or "leggings" in item_lower or "boots" in item_lower:
            return "tools"
        if "block" in item_lower or "log" in item_lower or "stone" in item_lower or "dirt" in item_lower or "planks" in item_lower or "glass" in item_lower or "ore" in item_lower:
            return "blocks"

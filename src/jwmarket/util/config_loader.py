...
_DEFAULT_MESSAGES = {
    ...
    "gui_item_lore_price": "§aPrice: {price}",
    "gui_item_lore_seller": "§7Seller: {seller}",
    "gui_item_lore_click": "§eClick to interact",
    "gui_btn_listing": "§e{item_name} §7x{amount}\n§a{price} §8- {seller}",
    "gui_btn_listing_no_seller": "§e{item_name} §7x{amount}\n§a{price}",
    "gui_listing_cancel_failed": "§cCould not cancel this listing.",
    "gui_btn_order": "§e{item_name}\n§7{filled} - §a{price}",
    "gui_order_cancel_failed": "§cCould not cancel this order.",
    "gui_order_item_name": "§eOrder: {item_name} §7x{remaining}",
    "gui_order_lore_price": "§aPrice: {price}/ea",
    "gui_order_lore_buyer": "§7Buyer: {buyer}",
    "gui_order_lore_click": "§eClick to fulfill",
    "gui_btn_order_browse": "§e{item_name} §7x{remaining}\n§a{price}/ea §8- {buyer}",
    "gui_order_creator_funds": "§cThe order creator does not have enough funds to pay for this.",
    "order_fulfilled_creator": "{prefix}Your order for {item_name} x{amount} has been fulfilled!",
    "gui_orders_page_title": "Orders (Page {page})",
    "gui_orders_page_content": "§7Active buy orders (page {page}):"
}
